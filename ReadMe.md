...
| 06 | [`Hold Date`](Files/Extensions/Hold_Date)<sup>1</sup> | Keeps selected file dates intact BEFORE command prompt window is `Enter`. | <img src="Documents/Pictures/Showcase/Hold_Date/File.png" height=50%> |
